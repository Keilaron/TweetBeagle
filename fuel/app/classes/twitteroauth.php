...
class TwitterOAuth {
  ...
  // :begin: fixes by @bush - Missing functionality
   ...
   */
  function getAccessToken($oauth_token, $oauth_verifier = FALSE) {
    $parameters = array();
  ...
  function oAuthRequest($url, $method, $parameters) {
    ...
    //Log::debug("oAuthRequest: [url=$url] [method=$method] [parameters=".var_export($parameters, true)."]");
    //Log::debug("oAuthRequest this->token: ".var_export($this->token, true)."]");
